...
-- {{{ Personal keybindings
  ...
  end, { description = "FOSS note taking application", group = "function keys" }),
  -- dmenu
  ...
  end, { description = "lock screen", group = "function keys" }),
  -- awful.key({ }, "F12", function () awful.util.spawn( "xflock4" ) end,
  --     {description = "lock screen" , group = "function keys"}),
  awful.key({ modkey }, "F1", function()
    awful.util.spawn("xfce4-taskmanager")
  end, { description = "Task Manager", group = "function keys" }),
  ...
  awful.key({ modkey }, "<", function()
    awful.util.spawn("bash /home/bytesudoer/.config/Dotfiles/config/rofi/launchers/type-4/launcher.sh")
  end, { description = "rofi resized", group = "function keys" }),
  awful.key({ modkey }, "Tab", function()
    awful.util.spawn("window_switcher")
  end, { description = "rofi window navigator", group = "hotkeys" }),
  ...
  end, { description = "Flameshot Utility", group = "screenshots" }),
  ...
  awful.key({}, "XF86AudioRaiseVolume", function()
    os.execute(string.format("amixer -q sset Master 10%%+"))
  ...
  awful.key({}, "XF86AudioMute", function()
    os.execute(string.format("amixer -q sset Master toggle"))
    -- beautiful.volume.update()
  end),
...
awful.rules.rules = {
  ...
  -- },
  { rule = { class = browser1 },                  properties = { maximized = false } },
  -- Floating clients.
  {
    rule_any = {
      instance = {
