{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "kcm_touchpad"."Toggle Touchpad" = ["Touchpad Toggle\\, Touchpad Toggle" "Meta+Ctrl+Zenkaku Hankaku,Touchpad Toggle,Toggle Touchpad"];
      ...
      "kwin"."Suspend Compositing" = "Alt+Shift+F12\\, ,Alt+Shift+F12,Suspend Compositing";
      ...
      "services/org.kde.dolphin.desktop"."_launch" = ["Meta+Shift+Return" "Meta+E"];
    ...
    configFile = {
      ...
      "kwinrc"."Tiling/12793ed5-1fb0-5329-b373-cd3f1bacd48e"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}x5d}";
      "kwinrc"."Tiling/213a9620-187e-58a6-b80b-85d8fb95dfce"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}x5d}";
      "kwinrc"."Tiling/27b8a485-dede-5bbb-9bd0-0cfc52449f58"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/68b7b471-fc7d-5fd9-8502-b3930c280d09"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/b0247fc9-b7bd-5754-9da6-b591acabbe69"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/f4b947e8-c2f9-5119-8f53-e5642e11527d"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
