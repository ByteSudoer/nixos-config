{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-0db87f4b-1874-4f13-b5d3-8c4ea4845eb7" = [ ];
      "ActivityManager"."switch-to-activity-9a5a8f04-dabe-4310-b264-b492e45bc27b" = [ ];
      "ActivityManager"."switch-to-activity-a4483998-bc8b-4a65-9e0f-51930638a6d5" = [ ];
      ...
      "ksmserver"."Lock Session" = ["F12" "Screensaver"];
      ...
      "lock-2.desktop"."_launch" = [ ];
      "lock.desktop"."_launch" = [ ];
      ...
      "thunar.desktop"."open-computer" = "Meta+Shift+Return";
      "thunar.desktop"."open-home" = [ ];
      "thunar.desktop"."open-trash" = [ ];
      "xfce4-appfinder-2.desktop"."_launch" = [ ];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."0db87f4b-1874-4f13-b5d3-8c4ea4845eb7" = "Default";
      "kactivitymanagerdrc"."activities"."9a5a8f04-dabe-4310-b264-b492e45bc27b" = "Default";
      "kactivitymanagerdrc"."activities"."a4483998-bc8b-4a65-9e0f-51930638a6d5" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "0db87f4b-1874-4f13-b5d3-8c4ea4845eb7";
      ...
      "kglobalshortcutsrc"."lock-2.desktop"."_k_friendly_name" = "lock";
      ...
      "kglobalshortcutsrc"."thunar.desktop"."_k_friendly_name" = "Thunar File Manager";
      "kglobalshortcutsrc"."xfce4-appfinder-2.desktop"."_k_friendly_name" = "xfce4-appfinder";
      "kglobalshortcutsrc"."xfce4-appfinder.desktop"."_k_friendly_name" = "Application Finder";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{b82c3a63-9be3-496c-a78a-a46a6d68f15e}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{fc873d75-88e4-4534-ae7a-968c929b88f6}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{0626301f-b68d-4ec7-a0fb-dd082eb81b03}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{bedb7bbf-d4c6-47f7-a3e4-4642ce333f42}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{2c3a932f-91cd-4ab7-8105-18709b4b1af8}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{eeb23156-d677-4bb9-815f-4d30f493d9ac}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{62e928f2-7c9f-4be1-964a-2ea7e070d1bb}";
      ...
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."Image" = "/nix/store/a7jszbwh7l4k0zvghkssav97qjnj6k1b-plasma-workspace-wallpapers-5.27.10/share/wallpapers/Flow/";
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."PreviewImage" = "/nix/store/a7jszbwh7l4k0zvghkssav97qjnj6k1b-plasma-workspace-wallpapers-5.27.10/share/wallpapers/Flow/";
      "kwalletrc"."Wallet"."First Use" = false;
      "kwinrc"."Desktops"."Id_1" = "eacddb2f-0262-4588-a1d7-069085ffc56a";
      ...
      "kwinrc"."Tiling.3cc38261-44cb-51c4-bcd6-47778411c1ad"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
