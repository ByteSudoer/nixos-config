{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "thunar.desktop"."_launch" = [ ];
      "thunar.desktop"."open-computer" = [ ];
      "thunar.desktop"."open-home" = "Meta+Shift+Return";
      "thunar.desktop"."open-trash" = [ ];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."b0b334e0-2a65-468c-b086-035bacaddc9a".value = "Default";
      "kactivitymanagerdrc"."main"."currentActivity".value = "b0b334e0-2a65-468c-b086-035bacaddc9a";
      "kcminputrc"."Mouse"."X11LibInputXAccelProfileFlat".value = true;
      "kcminputrc"."Mouse"."cursorTheme".value = "Dracula-cursors";
      ...
      "kdeglobals"."KDE"."widgetStyle".value = "gtk2";
      ...
      "kdeglobals"."KFileDialog Settings"."Speedbar Width".value = 163;
      "kdeglobals"."KFileDialog Settings"."View Style".value = "DetailTree";
      "kdeglobals"."WM"."activeBackground".value = "47,52,63";
      "kdeglobals"."WM"."activeBlend".value = "47,52,63";
      "kdeglobals"."WM"."activeForeground".value = "211,218,227";
      "kdeglobals"."WM"."inactiveBackground".value = "47,52,63";
      "kdeglobals"."WM"."inactiveBlend".value = "47,52,63";
      ...
      "kglobalshortcutsrc"."lock.desktop"."_k_friendly_name".value = "lock";
      ...
      "kglobalshortcutsrc"."thunar.desktop"."_k_friendly_name".value = "Thunar File Manager";
      "kglobalshortcutsrc"."xfce4-appfinder.desktop"."_k_friendly_name".value = "Application Finder";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid".value = "{51f09210-9a79-4d11-8493-e5b8cb50d05a}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid".value = "{e5b5fec5-1516-460c-a766-35e8882c81ef}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid".value = "{83d8c209-c648-4911-9168-4f4be669c8ed}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid".value = "{eb11bf67-34ee-4679-a99a-ba9830cc801e}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid".value = "{d308dcfd-c602-4db8-8467-2a93f87806f1}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid".value = "{bdd35809-7584-4f5b-b238-b8a6e9e06766}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid".value = "{0e0721c5-c130-4178-9732-67b07b6c04d0}";
      ...
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."Image".value = "/nix/store/a7jszbwh7l4k0zvghkssav97qjnj6k1b-plasma-workspace-wallpapers-5.27.10/share/wallpapers/Honeywave/";
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."PreviewImage".value = "/nix/store/a7jszbwh7l4k0zvghkssav97qjnj6k1b-plasma-workspace-wallpapers-5.27.10/share/wallpapers/Honeywave/";
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."Image".value = "/nix/store/16c2w2jvk9j5whgjjrbwa0y1xb1m1blc-plasma-workspace-wallpapers-5.27.10/share/wallpapers/MilkyWay/";
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."PreviewImage".value = "/nix/store/16c2w2jvk9j5whgjjrbwa0y1xb1m1blc-plasma-workspace-wallpapers-5.27.10/share/wallpapers/MilkyWay/";
      "kscreenlockerrc"."Greeter/Wallpaper/org/kde/image/General"."Image".value = "/nix/store/a7jszbwh7l4k0zvghkssav97qjnj6k1b-plasma-workspace-wallpapers-5.27.10/share/wallpapers/Honeywave/";
      "kscreenlockerrc"."Greeter/Wallpaper/org/kde/image/General"."PreviewImage".value = "/nix/store/a7jszbwh7l4k0zvghkssav97qjnj6k1b-plasma-workspace-wallpapers-5.27.10/share/wallpapers/Honeywave/";
      "kwalletrc"."Wallet"."First Use".value = false;
      "kwinrc"."Desktops"."Id_1".value = "8d725d18-9b04-4b15-8e5d-c66a5b650806";
      "kwinrc"."Desktops"."Id_2".value = "85d1e6ae-b65c-437a-8312-89208fe1de8f";
      "kwinrc"."Desktops"."Number".value = 2;
      "kwinrc"."Desktops"."Rows".value = 2;
      "kwinrc"."NightColor"."LatitudeAuto".value = 36.7496;
      "kwinrc"."NightColor"."LongitudeAuto".value = 10.2126;
      "kwinrc"."Tiling"."padding".value = 4;
      "kwinrc"."Tiling.12793ed5-1fb0-5329-b373-cd3f1bacd48e"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "plasmarc"."Theme"."name".value = "Dracula";
